package com.example.buyhome_login.ui.dashboard.dash_ui.big;
...
public class BigFragment extends Fragment implements DashCardRecyclerViewAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        rootview=inflater.inflate(R.layout.big_fragment, container, false);
        findView();
        setData();
        setAdapter();
        setListener();
    ...
    private void setData() {
        ...
        for(ProductEntry productEntry:productList){
            if(productEntry.tag.equals("big")){
