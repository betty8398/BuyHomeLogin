package com.example.buyhome_login.ui.dashboard.dash_ui.ccc;
...
public class CccFragment extends Fragment implements DashCardRecyclerViewAdapter.OnItemClickListener {
    ...
    public static CccFragment newInstance() {
        return new CccFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        rootview= inflater.inflate(R.layout.ccc_fragment, container, false);
        findView();
        setData();
        setAdapter();
        setListener();
