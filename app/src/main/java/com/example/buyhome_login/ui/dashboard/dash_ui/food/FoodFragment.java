package com.example.buyhome_login.ui.dashboard.dash_ui.food;
...
public class FoodFragment extends Fragment implements DashCardRecyclerViewAdapter.OnItemClickListener {
    ...
    private void setData() {
        ...
        for(ProductEntry productEntry:productList){
            if(productEntry.tag.equals("food")){
