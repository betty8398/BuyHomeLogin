package com.example.buyhome_login.ui.dashboard.dash_ui.clothing;
...
public class ClothFragment extends Fragment implements DashCardRecyclerViewAdapter.OnItemClickListener {
    ...
    public static ClothFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        rootview= inflater.inflate(R.layout.cloth_fragment, container, false);
        findView();
        setData();
        setAdapter();
        setListener();
    ...
    private void setData() {
        ...
        for(ProductEntry productEntry:productList){
            if(productEntry.tag.equals("cloth")){
